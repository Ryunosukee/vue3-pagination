module.exports = function (props) {
    return function (h) {
        ...
        if (this.opts.edgeNavigation && this.totalChunks > 1) {
            firstPage =
                <li class={`VuePagination__pagination-item ${theme.page} ${this.page === 1 ? theme.disabled : ''} VuePagination__pagination-item-first-page`}
            ...
            lastPage =
                <li class={`VuePagination__pagination-item ${theme.page} ${this.page === this.totalPages ? theme.disabled : ''} VuePagination__pagination-item-last-page`}
        ...
        if (this.opts.chunksNavigation === 'fixed') {
            prevChunk =
                <li class={`VuePagination__pagination-item ${theme.page} ${theme.prev} VuePagination__pagination-item-prev-chunk ${this.allowedChunkClass(-1)}`}
            ...
            nextChunk =
                <li class={`VuePagination__pagination-item ${theme.page} ${theme.next} VuePagination__pagination-item-next-chunk ${this.allowedChunkClass(1)}`}
                    onClick={this.setChunk.bind(this, 1)}
                >
                    <button type="button" class={theme.link}
        ...
        return <div class={`VuePagination ${theme.wrapper}`}>
            <nav class={`${theme.nav}`}>
